...
function Header() {
    ...
    return (
        <header className="flex items-center justify-between bg-blue-500 p-10 relative shadow-lg">
            <h1 className="title text-3xl flex-1 text-center ml-30 font-bold">PROJECT PLANNING</h1>
            <img src={notification} className="w-10 h-10 ml-6 hover:cursor-pointer" alt="Notification Icon" onClick={() => { setOpenNotifications(!openNotifications); setOpenMenu(false); }} />
            <div className="relative">
                <img
                    src={iconuser}
                    className="w-10 h-10 hover:cursor-pointer ml-4"
                    alt="User Icon"
